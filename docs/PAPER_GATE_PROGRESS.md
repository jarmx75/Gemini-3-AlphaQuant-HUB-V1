...
**Última Actualización**: `2026-09-02 00:28:42 UTC`  
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `Pairs_Stat_Arb_Base` | `CRYPTO_FUTURES` | `BINANCE` | **0 / 100** | **0.0%** | 100 | 0.0% | $0.00 | 0.00 | 0.0% | 16.1 | INSUFFICIENT_FORWARD_DATA | `PAPER_ACTIVE` |
| `Pairs_W90_Z2.5_S3.5_H24` | `CRYPTO_FUTURES` | `BINANCE` | **0 / 100** | **0.0%** | 100 | 0.0% | $0.00 | 0.00 | 0.0% | 15.41 | INSUFFICIENT_FORWARD_DATA | `PAPER_ACTIVE` |
| `Pairs_W90_Z2.4_S3.5_H24` | `CRYPTO_FUTURES` | `BINANCE` | **0 / 100** | **0.0%** | 100 | 0.0% | $0.00 | 0.00 | 0.0% | 15.41 | INSUFFICIENT_FORWARD_DATA | `PAPER_ACTIVE` |
| `TSMOM_1D_M1_N21` | `US_EQUITY_ETF` | `ALPACA` | **0 / 100** | **0.0%** | 100 | 0.0% | $0.00 | 0.00 | 0.0% | 12.93 | INSUFFICIENT_FORWARD_DATA | `PAPER_ACTIVE` |
| `TSMOM_1D_M2_N63` | `US_EQUITY_ETF` | `ALPACA` | **0 / 100** | **0.0%** | 100 | 0.0% | $0.00 | 0.00 | 0.0% | 12.93 | INSUFFICIENT_FORWARD_DATA | `PAPER_ACTIVE` |
