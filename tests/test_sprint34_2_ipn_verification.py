...
class TestSprint342IPNVerification(unittest.TestCase):
    ...
    def test_1_txn_id_primary_idempotency_key_deduplication(self):
        ...
        with patch("urllib.request.urlopen") as mock_urlopen:
            ...
            self.assertEqual(res1["idempotency_status"], "NEW_VERIFIED")
            ...
            self.assertEqual(res2["idempotency_status"], "DUPLICATE_IGNORED")
    ...
    def test_2_invalid_ipn_payload_rejection(self):
        ...
        with patch("urllib.request.urlopen") as mock_urlopen:
            ...
            self.assertEqual(res["idempotency_status"], "REJECTED")
