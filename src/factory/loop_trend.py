"""
Master Runner for Batch A: STRATEGY_FAMILY=TREND_FOLLOWING_4H
...
def run_trend_batch_a():
    ...
    print(f"⚡ [1/3] Generadas exactamente {len(candidates)} variantes de Donchian 4H...")
    ...
    for cand in candidates:
        ...
        if res.passed:
            cand_config = {
                "id": cand.id,
                "family": cand.family,
                "n_breakout": cand.n_breakout,
                "k_atr": cand.k_atr,
                "atr_period": cand.atr_period,
                "timeframe": "4h",
                "metrics": {
    ...
    print("\n" + "=" * 95)
    print("📊 [3/3] REPORTE DE RESULTADOS: BATCH A (TREND_FOLLOWING_4H)")
    print("=" * 95)
